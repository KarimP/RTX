...
void set_os_procs(void) {
    ...
    g_proc_table[7].m_pid = (U32)(11);
    g_proc_table[7].m_stack_size = 0x100;
    g_proc_table[7].m_priority = 0;
    g_proc_table[7].mpf_start_pc = &wall_clock_proc;

    g_proc_table[8].m_pid = (U32)(12);
    g_proc_table[8].m_priority = 0;
    g_proc_table[8].m_stack_size = 0x100;
    g_proc_table[8].mpf_start_pc = &kcd_proc;

    g_proc_table[9].m_pid = (U32)(13);
    g_proc_table[9].m_priority = 0;
    g_proc_table[9].m_stack_size = 0x100;
    g_proc_table[9].mpf_start_pc = &crt_proc;    

    g_proc_table[10].m_pid = (U32)(14);
    g_proc_table[10].m_stack_size = 0x0;
    g_proc_table[10].m_priority = 0;
    g_proc_table[10].mpf_start_pc = &timer_irq_proc;

    g_proc_table[11].m_pid = (U32)(15);
    g_proc_table[11].m_stack_size = 0x0;
    g_proc_table[11].m_priority = 0;
    g_proc_table[11].mpf_start_pc = &uart_irq_proc;    
}
